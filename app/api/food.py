...
@food_router.post("/", response_model=FoodOut)
...
@food_router.put("/{food_id}", response_model=FoodOut)
...
@food_router.delete("/{food_id}", response_model=FoodOut)
